...
import { selectThumbnail, setThumbnail } from '../../features/create/createArticleSlice';
import { useRef } from 'react';

function ThumbnailSelectButtons() {
  ...
  const handleImageChange = (e) => {
    ...
    if (file) {
      ...
      reader.onloadend = () => {
        dispatch(setThumbnail(reader.result)); // setThumbnail expects a dataURL
      };
...
export default ThumbnailSelectButtons;
