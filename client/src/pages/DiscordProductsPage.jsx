...
function DiscordProductsPage() {
  ...
  return (
    <div className='page flex flex-col isolate'>
      <Helmet>
        <title>Discord Bot Hosting | ZoBlaze</title>
        <meta
          name='description'
          content="Power your Discord bots with ZoBlaze's reliable bot hosting services. Designed for developers, our hosting ensures your bots are online 24/7 with minimal downtime."
        />
      </Helmet>
      ...
      {hasError && (
        <div className='min-h-[calc(100vh-10rem)] w-full flex flex-col justify-center items-center text-center px-4'>
          ...
          <p className='text-white mb-6'>
            We're having trouble loading the Discord Bot products right now. Please try again later.
          </p>
        ...
        <div className='flex w-full flex-col items-center mt-8'>
          ...
          <div className='relative w-full max-w-5xl mx-6'>
            ...
            <div
              ...
              {discordBot.map((item, idx) => (
                <DiscordProductCard key={idx} product={item} />
              ))}
              {searchTerm.length > 0 &&
...
export default DiscordProductsPage;
