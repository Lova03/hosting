  ...
  return (
    <div ref={dropdownRef}>
      ...
      <div
        ...
        />
        {opened ? (
          <ChevronUpIcon className='transition-colors duration-300 h-4 text-hunyadi-yellow' />
        ) : (
          <ChevronDownIcon className='transition-colors duration-300 h-4 group-hover:text-hunyadi-yellow' />
        )}
      </div>
      ...
      {opened && loggedIn && (
        <div
          ...
          <div className='flex flex-col mt-2 w-full overflow-y-auto flex-1 dropdown-scrollbar'>
            ...
            <Link className='userpanelitem' to='/settings'>
