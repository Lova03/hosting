...
function MinecraftProductCard({ product }) {
  ...
  const handleServerTypeChange = (option) => {
  ...
  const handleAddToCart = () => {
    ...
    const productToAdd = {
      ...product,
      serverType: selectedOption.value,
    };
    ...
    <div className='relative flex flex-col items-center w-72 mt-14 bg-english-violet-900 rounded-md transition-all duration-300 hover:bg-english-violet-850 group'>
      ...
      <div className='flex flex-col flex-1 w-full px-2 py-2'>
        ...
        <div className='flex flex-col w-full mt-2 items-center'>
          <span className='cursor-default text-sm font-bold ml-4 mr-auto'>Server Details</span>
          <div className='flex flex-col space-y-0.5 w-fit mt-1 py-2 px-6 rounded bg-dark-purple/40'>
            <span className='text-sm text-center'>Max Players: {product.maxPlayers}</span>
            <div className='flex items-center text-sm text-center'>
              <label htmlFor='server-type' className='mr-2'>
                Server Type:
              </label>
              <Select
                id='server-type'
        ...
        <div className='flex flex-col w-full mt-2 items-center'>
          ...
          <div className='flex flex-col space-y-0.5 w-fit mt-1 py-2 px-10 rounded bg-dark-purple/40'>
            ...
            <span className='cursor-default text-sm text-center'>Plugin Installer</span>
        ...
        <div className='mt-4 mb-2 flex justify-center'>
          <button
            ...
            className='bg-gradient-to-tr from-lime-500 to-emerald-500 text-white px-6 py-2 rounded transition-all duration-300 group-hover:px-12'>
            Add to Cart
          </button>
        </div>
      </div>
...
export default MinecraftProductCard;
