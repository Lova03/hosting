...
function DiscordProductCard({ product }) {
  ...
  const handleAddToCart = () => {
    ...
    const productToAdd = {
      ...product,
      botLanguage: selectedOption.value,
    };
      ...
      <div className='flex flex-col flex-1 w-full px-2 py-2'>
        ...
        <div className='flex flex-col w-full mt-2 items-center'>
          ...
          <div className='flex flex-col space-y-0.5 w-fit mt-1 py-2 px-6 rounded bg-dark-purple/40'>
            <div className='flex items-center text-sm text-center'>
              <label htmlFor='bot-language' className='mr-2'>
                Language:
              </label>
              <Select
                id='bot-language'
        ...
        <div className='mt-4 mb-2 flex justify-center'>
          <button
            ...
            className='bg-gradient-to-tr from-blurple-900 to-indigo-500 text-white px-6 py-2 rounded transition-all duration-300 group-hover:px-12'>
            Add to Cart
          </button>
        </div>
      </div>
...
export default DiscordProductCard;
